...
const Dashboard = () => {
    ...
    // const { getInvoicesByPeriod, getSalesAnalytics, getTopProducts } = useContext(DatabaseContext);
        ...
        const loadDashboardData = async () => {
            try {
                ...
                const salesData = {
                    ...
                    paidPercentage: res?.paid_percentage || 0,
                    debtAmount: res?.total_unpaid_sum || 0,
                    debtPercentage: res?.unpaid_percentage || 0,
                };
                ...
                //   "unpaid_percentage": 0
                // }
                console.log('🚀 ~ loadDashboardData ~ salesData:', salesData);
                ...
                const topProductsData = res?.top_products ?? [];
                                ...
                                <Grid item xs={12} sm={6} md={4}>
                                    ...
                                    >
                                        ...
                                        <Typography
                                            variant="h4"
                                            component="div"
                                            sx={{ color: 'success.main', fontWeight: 'medium', my: 1 }}
                                        >
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                            ...
                                            <Typography variant="body2" color="text.secondary">
                                                {/* {Math.round(
                                                    ((todaySales?.paidAmount || 0) / (todaySales?.totalSales || 1)) *
                                                        100
                                                )} */}
                                                {(todaySales?.paidPercentage || 0).toFixed(2)}% of total
                                            </Typography>
                                        </Box>
                                    </Paper>
                                </Grid>
                                <Grid item xs={12} sm={6} md={4}>
                                    ...
                                    >
                                        ...
                                        <Typography
                                            variant="h4"
                                            component="div"
                                            sx={{ color: 'error.main', fontWeight: 'medium', my: 1 }}
                                        >
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                            ...
                                            <Typography variant="body2" color="text.secondary">
                                                {/* {Math.round(
                                                    ((todaySales?.debtAmount || 0) / (todaySales?.totalSales || 1)) *
                                                        100
                                                )} */}
                                                {(todaySales?.debtPercentage || 0).toFixed(2)}% of total
                                            </Typography>
                                        </Box>
                                    </Paper>
                                </Grid>
                                    ...
                                    {isLoading ? (
                                        ...
                                        recentInvoices.map((invoice) => (
                                            <ListItem
                                                ...
                                                divider
                                                button
                                                onClick={() => navigateTo(`/invoice/${invoice.order_id}`)}
                                                sx={{
                                                    borderLeft: 4,
                                                    borderLeftColor:
                                            ...
                                            >
                                                ...
                                                <ListItemText
                                                    primary={`Invoice #${invoice.order_id}`}
                                                    secondary={`${formatDate(invoice.created_at)} - ${formatCurrency(
                                                ...
                                                <Typography
                                                    ...
                                                    sx={{
                                                        bgcolor:
                                                            invoice.status === 'paid' ? 'success.light' : 'error.light',
                                                        color:
                                                            invoice.status === 'paid'
