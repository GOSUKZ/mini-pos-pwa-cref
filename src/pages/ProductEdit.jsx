...
const ProductEdit = () => {
    ...
    useEffect(() => {
        const loadProduct = async () => {
            try {
                ...
                const productData = await apiClient.byIdLocalProduct(parseInt(id));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await apiClient.updateLocalProduct(parseInt(id), productData);
        ...
        showDeleteDialog(
            ...
            async () => {
                try {
                    ...
                    await apiClient.deleteLocalProduct(parseInt(id));
                ...
                <Paper elevation={2} sx={{ p: 3, mb: 2 }}>
                    ...
                    >
                        <Box>
                            ...
                            <Chip label={`ID: ${id}`} size="small" color="primary" variant="outlined" />
                        </Box>
