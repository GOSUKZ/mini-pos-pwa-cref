...
export const DatabaseProvider = ({ children }) => {
    ...
    const addProduct = useCallback(async (product) => {
        try {
            ...
            return await apiClient.addLocalProduct(product);
        } catch (err) {
    ...
    const updateProduct = useCallback(async (id, productData) => {
        try {
            ...
            return await apiClient.updateLocalProduct(id, productData);
        } catch (err) {
    ...
    const updateProductQuantity = useCallback(async (id, quantity) => {
        try {
            ...
            return await apiClient.updateLocalProduct(id, { quantity });
        } catch (err) {
    ...
    const findProductByBarcode = useCallback(async (barcode) => {
        try {
            ...
            return await apiClient.searchLocalProducts(barcode);
        } catch (err) {
    ...
    const findProductById = useCallback(async (id) => {
        try {
            ...
            return await apiClient.byIdLocalProduct(id);
        } catch (err) {
            setError(err.message || 'Failed to find product');
            throw err;
        }
    ...
    const getAllProducts = useCallback(async (sortBy = 'name') => {
        try {
            ...
            return await apiClient.getAllLocalProducts(sortBy);
        } catch (err) {
    ...
    const searchProducts = useCallback(async (searchTerm) => {
        try {
            ...
            return await apiClient.searchLocalProducts(searchTerm);
        } catch (err) {
